...
- **Panaversity students ko har exam ke 2 free attempts milte hain.** 3rd ya baad wala attempt ek fee
  (**TBA**) pe charge hota hai.
- **Baaqi sab sirf proctoring fee (currently TBA)** deta hai — Panaversity ke sath study karna zaroori
  nahi.

**Do-attempt policy jaan-boojh kar hai:** ek attempt zyada pressure banata hai, unlimited attempts
exam ko trial-and-error bana dete hain. Do attempts real second chance dete hain, aur preparation ko
reward bhi karte hain.
...
1. **Anthropic attempt paisa aur waqt dono kharch karta hai** — ek sitting **$99 se $175**. Successive
   failures ke baad wait: **14, 30, aur 90 din**. Ready hone se pehle book karna fee **aur** mahinon ka
